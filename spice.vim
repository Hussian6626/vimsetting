...
" Subckt name
syntax region spiceCkt matchgroup=spiceSubCkt start=+.subckt\s+  end=+\s+
syntax region spiceCkt matchgroup=spiceSubCkt start=+.ends\s+ end="\v$"
...
" INCLUDE
syntax region spiceInclude matchgroup=spiceLibManagement start=+.include\s+ end="\v$"
